...
import static org.solarframework.discord.lang.L10N.TL;
...
public class MiscUtils {
    ...
    public static boolean isSyntaxValid(InteractionHook M, String text) {
        ...
        M.editOriginal(TL(M, "error-illegal-character")).queue();
        return false;
    }
    ...
    public static boolean isInviteLinkValid(InteractionHook M, String text) {
        ...
        M.editOriginal(TL(M, "error-invalid-invite-link")).queue();
        return false;
    }
    ...
    public static boolean isURLValid(InteractionHook M, String text) {
        ...
        M.editOriginal(TL(M, "error-invalid-url-link")).queue();
        return false;
    }
    ...
    public static boolean isDateValid(InteractionHook M, String text) {
        ...
        M.editOriginal(TL(M, "error-invalid-date")).queue();
        return false;
    }
